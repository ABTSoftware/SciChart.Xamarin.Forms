...
namespace TestApp.UI.Data
{
    public class DataManager
    {
        ...
        private const string WaterfallData = Prefix + "WaterfallData.txt";
        ...
        {
            var r = _random.Next(50, 255) / 255d;
            var g = _random.Next(50, 255) / 255d;
            var b = _random.Next(50, 255) / 255d;
        ...
        {
            return GetPriceBarsFromPath(PriceDataIndu);
        }

        public PriceSeries GetPriceDataEurUsd()
        {
            return GetPriceBarsFromPath(PriceDataEurUsd);
        }
        ...
        public List<double> LoadWaveformData()
        {
            ...
            foreach (var line in ReadFile(Waveform))
            {
        ...
        public List<List<double>> LoadFFT()
        {
            ...
            foreach (var line in ReadFile(FFT))
            {
        ...
        public List<List<double>> LoadWaterfallData()
        {
            ...
            foreach (var line in ReadFile(WaterfallData))
            {
        ...
        public IEnumerable<TradeData> GetTradeticks()
        {
            ...
            foreach (var line in ReadFile(TradeTicks))
            {
        ...
        {
            var assembly = Assembly.GetAssembly(typeof(DataManager));
